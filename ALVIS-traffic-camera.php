    ...
    <main>
        <section class="detail-product" id="detail-product">
            <div class="container">
                ...
                <div class="row">
                    <div class="detail-product-items col-md-6 col-sm-12">
                        <h1 class="detail-product-items-name text-blue-color text-uppercase fw-800">ALVIS TRAFFIC CAMERA
                        </h1>
                        <p class="detail-product-items-subname font-size-18">Traffic monitoring camera</p>
                        <ul>
                ...
                <div class="row">
                    <div class="mr-4">
                        <div class="card border-grey-color">
                            <img src="./assets/images/model-1-of-product1.svg" class="card-img-top bg-light-grey" alt="">
                    ...
                    <div class="mr-4">
                        <div class="card border-grey-color">
                            <img src="./assets/images/model-2-of-product1.svg" class="card-img-top bg-light-grey" alt="...">
                            <div class="card-body text-center py-3 px-4">
                                <h5 class="card-title fw-700 mb-2">ALVT - 35 - 1150</h5>
                                <p class="card-text">ALVIS Speed Camera dial 3MP & 5MP P-IRIS Lens 11 - 50mm</p>
                            </div>
                    ...
                    <div class="">
                        <div class="card border-grey-color">
                            <img src="./assets/images/model-3-of-product1.svg" class="card-img-top bg-light-grey" alt="">
                            <div class="card-body text-center py-3 px-4">
                                <h5 class="card-title fw-700 mb-2">ALVT - 35 - 1150</h5>
                                <p class="card-text">ALVIS Speed Camera dial 3MP & 5MP P-IRIS Lens 11 - 50mm</p>
                            </div>
