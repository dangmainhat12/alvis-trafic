...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 heading-main-box">
                    ...
                    <p class="descript-heading fw-400 font-size-18 text-white mb-4">AI - based Video analytics platform</p>
    ...
    <main>
        <section class="category-child-products" id="category-child-products">
            <div class="container">
                <div class="row">
